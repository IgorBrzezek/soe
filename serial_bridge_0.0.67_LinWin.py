...
# Version: 0.0.67 [NEW: Full Config Support + Custom Colors]
# Date: 02.02.2026
# Author: Igor Brzezek
# ==============================================================================
...
__CODE_VERSION__ = "0.0.67"
__CODE_DATE__    = "02.02.2026"
...
def load_hierarchical_config():
    ...
    parser.add_argument("--keepalive", type=int); parser.add_argument("--secauto", action="store_true", default=None)
    ...
    parser.add_argument("--color", action="store_true", default=None); parser.add_argument("--count", action="store_true", default=None)
    ...
    parser.add_argument("--help", action="store_true"); parser.add_argument("--ask", action="store_true", default=None)
    parser.add_argument("--cfgfile"); parser.add_argument("--notui", action="store_true", default=None)
